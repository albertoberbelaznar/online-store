...
use Online\Store\Product\Application\ShoppingCart\GetShoppingCartPriceUseCase;
use Symfony\Component\HttpFoundation\JsonResponse;
use Symfony\Component\HttpFoundation\Request;

class GetShoppingCartPriceController
{
    public function __construct(private readonly GetShoppingCartPriceUseCase $useCase)
    {
    }
